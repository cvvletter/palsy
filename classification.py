   ...
   # Measures 31 and 32: Best line fit of 3 most left points of each eye and keep the slope of each eye to a list
    ...
    #The following metrics might be used for manual metrics of patients
            ...
            if int(manual_an)==1: #These are the threshods for manual annotation
                       if eyeopening[i]>1900 or broweyedif[i]>1800 or eyeopening0[i]>1700 or eyeopening1[i]>2400 or eyeopening3[i]>3000 or moutheyes5[i]>2300 or eyeopening3b[i]<6000 or listlefte4[i]>490 or eyeopeninga[i]>3000 or listrighte3[i]<40 or listrighte[i]<200 or listrighta3[i]>600 or moutheyes[i]>30:   
                       #Above are the best thresholds found 
                           print("Image {} is classified as patient (manual annotation)".format(listofnames[i]))
                           if eyeopening[i]>2700 or broweyedif[i]>4500 or eyeopening1[i]>8000 or eyeopening3[i]>9000 or eyeopening3[i]<380 or broweyedif1[i]>6500 or broweyedif1[i]<3300 or moutheyes0[i]>2000 or moutheyes[i]>120 or eyesnose[i]>60 or eyestopleftmouth[i]>80 or eyesbottomrightmouth[i]>105 or listline[i]>700 or listlefte4[i]>570 or listbroweye[i]>90 or lenratio[i]<20 or broweyedif2[i]<2000 or eyeopening3a[i]>15500 or listmouthbrow[i]>580 or listbroweye2[i]>150 or listrighta2[i]>-10 or listrighte2[i]>500 or listrighta3[i]>730 or listrighta4[i]<-1600 or listrighte3[i]>250  or listrighte3[i]<-200 or listeyedif[i]>90 or listbrowdif[i]<50 or listbrowdif[i]>140:
                       ...
                       if moutheyes[i]>30 or eyestopnose[i]>110 or eyeschinlow[i]>35 or mouriglist[i]>700 or broweyedif[i]>1800 or listline[i]>650 or listbroweye2[i]<35 or listlefte4[i]>470 or listrighta1[i]<110 or listlefta2[i]>150 or eyeopening1[i]>2400 or eyeopening3[i]>2900 or moutheyes5[i]>2200 or eyeopening3b[i]<6300 or listline[i]<450 or listmouthbrow[i]>520 or listlefte[i]<200 or listbrowdif[i]>140 or eyesbottomrightmouth[i]>85 or eyesbottomrightmouth[i]<15:
                           print("Image {} is classified as patient (automatic annotation)".format(listofnames[i]))
                           if eyeopening[i]>1400 or eyeopening1[i]>4100 or eyeopening3[i]>5900 or broweyedif1[i]>6600 or broweyedif1[i]<3300 or moutheyes5[i]>4200 or eyeopeninga[i]>2600 or listline[i]>650 or eyeopening3a[i]>15500 or listlefte2[i]<-115 or listlefte4[i]>460 or listbroweye2[i]>120 or listlefta1[i]<100 or listrighte3[i]>270 or eyeopeningb[i]>23 or eyeopening0[i]>2600 or listslrightleft[i]>490 or listmouthbrow[i]>550 or moutheyes0[i]>1980 or listlefta2[i]<-47 or listlefte3[i]<80 or eyestopleftmouth[i]>55 or eyesbottomrightmouth[i]>100 or newmet[i]>10 or newmet2[i]>20 or lenratio[i]>150:
